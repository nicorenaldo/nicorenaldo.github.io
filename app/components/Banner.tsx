...
const Banner = () => {
  return (
    <div className='xl:min-h-[80vh] flex flex-col gap-12 mt-8 mb-16 xl:mb-0 xl:mt-24 xl:pr-96 z-10'>
  ...
  return (
    <>
      <a
        ...
        target='_blank'
      >
        <MailIcon className='h-8 w-8 text-gray-500 hover:text-gray-900 transition-colors' />
      </a>
      <a
        ...
        target='_blank'
      >
        <GitHubIcon className='h-8 w-8 text-gray-500 hover:text-gray-900 transition-colors' />
      </a>
      <a
        ...
        target='_blank'
      >
        <LinkedInIcon className='h-8 w-8 text-gray-500 hover:text-gray-900 transition-colors' />
      </a>
    </>
  );
};
