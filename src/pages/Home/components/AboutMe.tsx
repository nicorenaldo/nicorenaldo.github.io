...
const AboutMe = () => {
    return <SectionLayout title="About Me">
        <Title className="font-light">
            I am a software engineer with over 3 years experience working on multiple research project across diverse topics. I'm passionate with web development, machine learning, and embedded programming topics.
        </Title>
        <br />
        <Title className="font-light">
            Currently employed as a junior engineer at Sea Ltd., A company focusing on e-Commerce, Banking and Gaming industry.
        </Title>
        <br />
