...
const DoviProject = () => {
    ...
    return <ProjectLayout title="Dovi" date="27 November 2022" >
        ...
        <Body>
            The repetition algorithm is partly adopted from <a className="underline" href="https://apps.ankiweb.net/" aria-label="Anki Official Website">Anki</a>, a popular open-source spaced repetition apps.
        </Body>
        <Body>
